...
public class JpaUtil {
  ...
  // *************************************************************************************
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "fr.insalyon.dasi_Collectif3434_jar_1.0-SNAPSHOTPU";
    /**
...
//        pause(5);
    ...
    public static Query request(String str){
    ...
    public static Date creerDate(String date){
        ...
        Date dt = new Date();
        //String dat = "11/05/2010 12:00:00";
        String formatedDate = date+" 12:00:00";
        try {
            dt = new java.text.SimpleDateFormat(format).parse(formatedDate);
